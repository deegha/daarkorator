...
class DbHandler {
    ...
    public function getUser($id=null) {
        try {
            ...
            $rows = 'u.id, u.user_type, u.first_name ,u.last_name, u.email, u.user_image, u.contact_number, u.status ,du.company_name, du.about, du.tranings, du.tools, du.instagrame, du.website, ut.id as type_id, ut.type_name, case u.status WHEN 0 then "Pending" WHEN 1 then "Active" when 2 then "Inactive" when 5 then "Pending Approval" when 6 then "Declined"  END AS status_title';
            $where = ' u.status<>3';
    ...
    public function getUsers($type=null, $status=null){
        try{
            $db           = new database();
            $table        = "user";
